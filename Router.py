...
interface_lan = input('Enter your device LAN interface: ')
address_LAN = input('Enter new IP + mask address for the LAN port: ')
interface_wan = input('Enter your device WAN interface: ')
...
if ser.is_open:
        ...
        send_command('interface ' + interface_lan)
        send_command('ip add ' + address_LAN)
